...
from .views import  UsuarioListView, PublicacionListView, UsuarioCreateView, NutricionistaCreateView, LoginView, NoticiasListView, EventosListView, TestimoniosListView
